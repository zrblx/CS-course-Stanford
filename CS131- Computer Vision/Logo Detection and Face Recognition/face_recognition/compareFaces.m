...
%       the testImg face
    ...
    new_testImg = zeros(0);
    for y= 1:col
        new_testImg = [new_testImg;testImg(:,y)];
    end
    testImg = new_testImg-meanFace;
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %                                                                     %
    %                            END YOUR CODE                            %
    %                                                                     %
    ...
    elseif strcmp(method,'eigenface')
        ...
        test_weight = prinComponents'*testImg;
        training_PCA = prinComponents'*A;
        %numComponentsToKeep*1
        [dist, indexOfClosestMatch] = indexOfClosestColumn(training_PCA, test_weight);
